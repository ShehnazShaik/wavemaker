  ...
  <div class="sidebar-content">
    ...
    <div class="card card-sidebar-mobile">
      <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li id="userprofileid" class="nav-item nav-item-submenu hidden active">
        ...
        <li  id="createplan"  class="nav-item nav-item-submenu hidden">
          <a href="planner_createnewplan.php" class="nav-link" style="color: #fff !important;"><i class="icon-copy"></i> <span>Create New Plan</span></a>
        </li>
        ...
        <li  id="myplans"  class="nav-item nav-item-submenu hidden">
          <a href="planner_ongoing_dashboard.php" class="nav-link" style="color: #fff !important;"><i class="icon-stack"></i> <span>My plans</span></a>
        </li>

        <li  id="ongoingdashboard"  class="nav-item nav-item-submenu hidden">
          <a href="planner_dashboard.php" class="nav-link" style="color: #fff !important;"><i class="icon-stack"></i> <span>Ongoing Plans</span></a>
        </li>

        <li  id="add_deleteid"  class="nav-item nav-item-submenu hidden">
          <a href="add_delete.php" class="nav-link" style="color: #fff !important;"><i class="icon-stack"></i> <span>Assign Planner</span></a>
        </li>
        ...
        <li  id="admin" class="nav-item hidden">
